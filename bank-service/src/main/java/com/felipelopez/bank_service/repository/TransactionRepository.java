...
public interface TransactionRepository extends JpaRepository<Transaction, Long> {
    ...
    List<Object[]> getTransactionCountByDateRangeAdnAccountNumber(@Param("startDate")LocalDate startDate, @Param("endDate")LocalDate endDate, @Param("accountNumber")String accountNumber);
}
